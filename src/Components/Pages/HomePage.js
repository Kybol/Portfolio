      ...
      <div class="flex flex-row justify-center items-center">
        <div class="w-1/4">
          ...
          <div class="flex gap-5 mt-10">
            ...
            <!-- Instagram -->
            <a href="https://www.instagram.com/ky_bol_/" target="_blank" rel="noopener noreferrer" class="[&>svg]:h-10 [&>svg]:w-10 hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512">
            ...
            <!-- Linkedin -->
            <a href="https://www.linkedin.com/in/kimberley-blomme-3a0914210/" target="_blank" rel="noopener noreferrer" class="[&>svg]:h-10 [&>svg]:w-10 hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512">
